...
export default class App extends Component {
    ...
    stockSumTotalValue = () => {
        ...
        for (let d of groupList) {
            if (Data.getStockQuote(d.code)) {
                let current = Data.getStockQuote(d.code).current;
    ...
    stockRenderReturnsCell = (price, quote) => {
        if (!price || !quote) {
            return;
        }
    ...
    stockRenderProportionCell = (count, quote, totalValue) => {
        if (!count || !quote) {
            return;
        }
    ...
    stockRenderBlock=()=>{
        ...
        let totalValue = this.stockSumTotalValue();
        return (
                    ...
                    groupList.map((g, i) => {
                        ...
                        return (<div className="record-group">
                            <div className="group-item">
                                ...
                                <div className="list-col returns">{this.stockRenderReturnsCell(g.price, quote)}</div>
                                ...
                                <div className="list-col proportion">{this.stockRenderProportionCell(g.count, quote, totalValue)}</div>
                                ...
                                g.visible == true && g.recordList && g.recordList.map(d => {
                                    return (
                                        <div className="record-item">
                                            ...
                                            <div className="list-col returns">{this.stockRenderReturnsCell(d.price, quote)}</div>
                                            ...
                                            <div className="list-col proportion">{this.stockRenderProportionCell(d.count, quote, totalValue)}</div>
                                            <div className="list-col oper">
